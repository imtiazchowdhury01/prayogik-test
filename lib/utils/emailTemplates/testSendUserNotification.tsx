...
export const sendUserNotification = (
  ...
  if (isNewUser && isEventRegistration) {
    mainMessage =
      "আপনার প্রয়োগিক প্ল্যাটফর্মে অ্যাকাউন্ট সফলভাবে তৈরি করা হয়েছে এবং ইভেন্ট রেজিস্ট্রেশন সম্পন্ন হয়েছে। প্ল্যাটফর্মে স্বাগতম!";
    sectionTitle = "অ্যাকাউন্ট ও ইভেন্ট বিবরণ";
  } else if (isNewUser && !isEventRegistration) {
    mainMessage =
      "আপনার প্রয়োগিক প্ল্যাটফর্মে অ্যাকাউন্ট সফলভাবে তৈরি করা হয়েছে। প্ল্যাটফর্মে স্বাগতম!";
