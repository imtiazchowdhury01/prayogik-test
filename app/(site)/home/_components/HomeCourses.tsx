...
import { getHomeCoursesDBCall } from "@/lib/data-access-layer/getHomeCourses";
import { ArrowRight } from "lucide-react";
import Link from "next/link";

const HomeCourses = async () => {
  const courses = await getHomeCoursesDBCall();
          ...
          {courses?.length >= 8 && (
            <Link href="/courses">
              <Button
                ...
                // className="text-gray-700 border-gray-300 transition-all duration-300 py-4 h-12 md:flex"
              >
                কোর্সগুলো দেখুন{" "}
