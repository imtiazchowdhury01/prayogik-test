...
const SubscriptionCheckoutForm = ({
  ...
  // Check if user is trying to buy the same subscription plan
  const isSamePlan =
    currentSubscription &&
    hasActiveSubscription &&
    currentSubscription.subscriptionPlanId === plan.id;
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex sm:flex-row flex-col gap-2">
                  ...
                  {/* Change Email Option for unAuth users */}
                  {!session?.user?.email && (
                    <Button
                      type="button"
                      variant="ghost"
            ...
            >
                ...
                !emailContinued && (
                  ...
                  >
                    {isCheckingSubscription ? (
                      ...
                      <>
                        এগিয়ে যান <ArrowRight className="ml-2 h-4 w-4" />
                      </>
                    )}
                  </Button>
                )}
                ...
                !isSamePlan && (
                  <div className="p-4 bg-brand/5 text-gray-700 text-base py-4 rounded flex gap-3">
                    ...
                    <div>
                      ...
                      {isActivePrimeSubscription ? (
                        <p className="text-sm ">
                          বর্তমান প্ল্যান শেষ না হওয়া পর্যন্ত আপনি ট্রায়াল
                          প্ল্যানে পরিবর্তন করতে পারবেন না।
                        </p>
                      ) : null}
                    </div>
                  </div>
                    ...
                    <FormItem className="space-y-3">
                      ...
                      <FormControl>
                        <RadioGroup
                          ...
                          disabled={!hasCheckedSubscription}
                        >
                          {/* Subscription/Trial Option (all plans now require payment) */}
                          <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-4 border rounded-lg hover:bg-gray-50 gap-x-3 md:gap-4 ">
                            {/* Left Section with Radio + Content */}
                            <div className="flex items-start gap-3 flex-1">
                              <RadioGroupItem
                              ...
                              <div className="flex-1">
                                ...
                                >
                                  <span className="text-lg font-semibold">
                                    {plan.isTrial &&
                                      !currentSubscription &&
                                      "ট্রায়াল প্ল্যান ক্রয় করুন"}
                                    {plan.isTrial &&
                                      hasActiveSubscription &&
                                      !isSamePlan &&
                                      "ট্রায়াল প্ল্যানে আপগ্রেড করুন"}
                                    {plan.isTrial &&
                                      isExpiredSubscription &&
                                      "ট্রায়াল প্ল্যান রিনিউ করুন"}
                                    {!plan.isTrial &&
                                      hasActiveSubscription &&
                                      !isSamePlan &&
                                      "প্ল্যান আপগ্রেড করুন"}
              ...
              {!isEmillEmtpy && (
                <div className="flex justify-between items-center mt-4 text-xl font-bold border-t pr-2.5">
                  <p className="pt-2">সর্বমোট</p>
                  <p className="pt-2">
                    ৳{convertNumberToBangla(watchedAmount)}
                  </p>
                </div>
              )}
              {hasCheckedSubscription && !isEmillEmtpy && (
                <>
                  <Button
                    type="submit"
                    className="w-full whitespace-nowrap shadow-customButton transition-colors duration-300 size-lg h-12 disabled:bg-gray-400 disabled:text-gray-200 bg-[#E2136E] hover:bg-[#d70d65]"
                    size="lg"
                    disabled={
                      isProcessing ||
                      isPaymentSuccessful ||
