  ...
  return (
    <div>
      <SectionTitle
        ...
        description="ফাউন্ডেশন থেকে স্পেশালাইজেশন—ডিজিটাল মার্কেটিংয়ে সফল ক্যারিয়ারের জন্য প্রয়োজনীয় সবকিছু একই প্লাটফর্মে। একটি সাবস্ক্রিপশনে পাচ্ছেন স্কিল শেখা, ক্যারিয়ার গড়া আর প্রফেশনাল কমিউনিটির সাপোর্ট—সব একসাথে।"
