      ...
      <div className="max-w-7xl mx-auto 2xl:px-0 xl:px-8 lg:px-6 md:px-7 px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-2 lg:text-left text-left">
            <h1 className="text-3xl lg:text-5xl text-center lg:text-left font-semibold md:font-bold text-gray-900 leading-tight mt-3">
            ...
            {faqItems.map((item, index) => (
              ...
              >
                <button
                  ...
                  className={`w-full text-left flex items-start md:items-center justify-between ${
