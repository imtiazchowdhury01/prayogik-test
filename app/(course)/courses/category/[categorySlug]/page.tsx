...
//   switch (filterType) {
//     case "recent":
//       const [{ courses: recentCoursesResponse }, recentCategories] =
//         await Promise.all([
//           getCoursesDbCall({
...
//           getCategoriesDBCall(),
//         ]);
//       courses = recentCoursesResponse ?? [];
//       categories = recentCategories;
//       break;

//     case "older":
//       const [{ courses: olderCoursesResponse }, olderCategories] =
//         await Promise.all([
//           getCoursesDbCall({
...
//   const courses = await getCategoryCoursesDBCall(categorySlug);
//   const categories = await getCategoriesDBCall();
