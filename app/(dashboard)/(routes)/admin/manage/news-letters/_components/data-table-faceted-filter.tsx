    ...
    <Popover>
      <PopoverTrigger asChild>
        ...
        <Button
          variant="outline"
          size="sm"
          className="flex items-center h-8 border-dashed"
        >
                  ...
                  options
                    ...
                    .map((option) => (
                      <Badge
                        variant="secondary"
                        key={option.value}
                        className="px-1 font-normal rounded-sm capitalize"
                      >
                        {option.label}
                      </Badge>
                    ))
      ...
      <PopoverContent className="w-[200px] p-0" align="start">
        <Command>
          <CommandInput
            placeholder={title}
            className="focus-visible:border-gray-500 focus-visible:ring-0"
          />
          <CommandList>
