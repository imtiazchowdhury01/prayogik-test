...
import { uploadEventImageToS3 } from "@/actions/upload-aws";
...
export const EventImageForm = ({ initialData, eventId }: ImageFormProps) => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const response = await uploadEventImageToS3(formData, eventId);
