...
const CreateCertificationCoursePage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      const { body } = await clientApi.createCertification({
        body: {
          ...values,
        },
      });
      router.push(`/admin/certifications/${body?.id}`);
      router.refresh();
      toast.success("Certification Course created");
    } catch (error) {
        ...
        <Form {...form}>
          ...
          >
                    ...
                    <Input
                      ...
                      onKeyDown={(event) => {
                        ...
                        if (
                          ...
                          event.preventDefault(); // Ignore/block uppercase letters
                          return;
                        }
                      }}
                      {...field}
            ...
            <div className="flex items-center gap-x-2">
              <Link href="/teacher/certifications">
...
export default CreateCertificationCoursePage;
