...
import { uploadCertificationElementToS3 } from "@/actions/upload-aws";
...
export const CertificationImageForm = ({
  initialData,
  certificationId,
  api,
  successMessage,
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      formData.append("certificationSrc", file);
      ...
      const response = await uploadCertificationElementToS3(
        formData,
        certificationId
      );
