...
//       const recentCourses = await getCategoryCoursesDBCall(categorySlug);
...
//       const olderCourses = await getCategoryCoursesDBCall(categorySlug);
...
//       courses = await getPrimeCoursesByCategoryDBCall(categorySlug);
//       break;
