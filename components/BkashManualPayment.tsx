...
function BkashManualPayment({
  ...
  if (preview) {
    return (
      <Card className={cn(cardClassName)} style={{ ...dynamicStyles.card }}>
        <CardHeader className={cardHeaderClassName}>
          {cardTitle ? (
            <CardTitle
              style={dynamicStyles.title}
              className={cn("-mb-3 text-base")}
            >
              {cardTitle}
            </CardTitle>
          ) : null}
  ...
  return (
    <>
      ...
      <Card className={cardClassName} style={dynamicStyles.card}>
        {cardTitle && (
          <CardHeader className={cardHeaderClassName}>
            {cardTitle ? (
              <CardTitle className="text-base" style={dynamicStyles.title}>
                {cardTitle}
              </CardTitle>
            ) : null}
        ...
        <CardContent className={cardContentClassName}>
          ...
          <div className="mt-4">
            <div className="text-sm" style={dynamicStyles.description}>
              {paymentInstruction}
            </div>
          ...
          <div className="space-y-2">
            <div className="text-sm">{defaultLabels.step1}</div>
              ...
              {!showTrxIdInput ? (
                <>
                  <Button
                    ...
                    variant="outline"
                    className={cn(
                      "w-full hover:bg-primary-brand hover:text-white bg-primary-brand text-white transition-opacity",
                      buttonSubmitTailwindcss
                    )}
                ...
                <div className="bg-white space-y-4 p-4 border rounded-md">
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <div className="relative group inline-block ">
                        <CircleHelp className="w-4 h-4 relative -top-0.5 cursor-pointer" />
                        <div className="absolute bottom-full mb-1 left-1/2 -translate-x-1/2 whitespace-wrap rounded w-[250px] bg-white border px-2 py-1 text-xs opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                          আপনার বিকাশ পেমেন্ট থেকে পাওয়া অনন্য ট্রান্সেকশন আইডি
                          দিন। উদাহরণ: TX123ABC456
                        </div>
                      </div>
                    </Label>
                    <Input
                  ...
                  {showRecaptcha && (
                    <div className="mt-4">
                      <div className="w-[160px] h-[60px] sm:w-[180px] sm:h-[60px] lg:w-[200px] xl:w-[234px] xs:w-[150px] xs:h-[55px] overflow-x-auto overflow-y-hidden">
                        <div
                          ref={recaptchaRef}
                          className="origin-top-left scale-[0.658] sm:scale-[0.769] xs:scale-[0.700]"
                        />
                      </div>
                      {recaptchaError && (
          ...
          {/* Step 2 */}
          <div className="space-y-1">
            <div className="text-sm">{defaultLabels.step2}</div>
...
export default BkashManualPayment;
