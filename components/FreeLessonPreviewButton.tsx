  ...
  return (
    <>
      <button
        ...
        className="w-11 h-11 z-10 flex items-center justify-center rounded-full cursor-pointer bg-brand transition-all duration-500 hover:opacity-70  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 "
      >
        <Image
