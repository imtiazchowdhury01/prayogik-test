        ...
        <div className="relative w-full h-40 overflow-hidden">
          ...
          {freeLesson && (
            <button
              ...
              className="w-11 h-11 z-10 flex items-center justify-center rounded-full cursor-pointer bg-brand  transition-all duration-300 hover:opacity-70 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            >
              <Image
